...
source=("https://github.com/OpenBoard-org/OpenBoard/archive/v${pkgver}.tar.gz"
        "openboard-support-poppler-25.12.patch::https://patch-diff.githubusercontent.com/raw/OpenBoard-org/OpenBoard/pull/1387.patch")
sha256sums=('55532df042e3a5b36e1f6f1e29916d3bbd01796d920782fa1f8a03438dcddd9c'
            '916c27c537478e95a9601e529136e5f150cde6a2c4d4e4e557081020e4e60319')

prepare() {
  cd "$srcdir"/$_src_folder
  patch -p1 -i ../openboard-support-poppler-25.12.patch
}
