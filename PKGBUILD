...
source=("https://github.com/OpenBoard-org/OpenBoard/archive/v${pkgver}.tar.gz"
        ...
        "openboard-add-qt-6.8-support.patch::https://github.com/OpenBoard-org/OpenBoard/commit/d7cf544678c1fbcd31c56a1bdf5e7d7133183049.patch")
sha256sums=('5c9fcb54bc1598b4b7026e6ecca07137660dd3d45bda472a5710acf600a2a22f'
            ...
            '6c55d4a099a5006fc3401feccb56e7935b2184e63dc546aca0fa257aff929167')
...
prepare() {
  ...
  echo "Add support for Qt 6.8"
  patch -p1 < "$srcdir"/openboard-add-qt-6.8-support.patch
}
